<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"E:\xampp\htdocs\ArcticTern_1/application/admin\view\index\memberlist.html";i:1532935120;}*/ ?>
<!DOCTYPE html>
<html>
          ...
          <tr>
            ...
            <td class="td-manage">
              ...
              <!--<a onclick="x_admin_show('修改密码','<?php echo url('memberPassword'); ?>',600,400)" title="修改密码" href="javascript:;">-->
                <!--<i class="layui-icon">&#xe631;</i>-->
              <!--</a>-->
              <a title="删除" onclick="member_del(this,'要删除的id')" href="javascript:0;">
                <i class="layui-icon">&#xe640;</i>
              </a>
            </td>
          </tr>
    ...
    <script>
      ...
      function member_del(obj){
          layer.confirm('确认要删除吗？',function(index){
            $id = $(obj).parents("tr").children("#Id").text();
              $.ajax({
                type:'post',
                url:'../../admin/update/delmember',
                data:{"$id":$id},
                dataType:'JSON',
