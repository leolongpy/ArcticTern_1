<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\xampp\htdocs\ArcticTern_1/application/admin\view\index\adminrole.html";i:1532931201;}*/ ?>
<!DOCTYPE html>
<html>
  ...
  <body>
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加用户','<?php echo url('roleAdd'); ?>')"><i class="layui-icon"></i>添加</button>
        ...
        <tbody>
          <tr>
            ...
            <td class="td-manage">
              ...
              <a title="编辑"  onclick="x_admin_show('编辑','<?php echo url('roleAdd'); ?>')" href="javascript:;">
                <i class="layui-icon">&#xe642;</i>
              </a>
