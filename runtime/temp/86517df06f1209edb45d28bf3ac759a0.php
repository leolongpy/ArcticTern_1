<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\phpStudy\PHPTutorial\WWW\ArcticTern_1/application/about\view\index\index.html";i:1529657570;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<header>
    ...
    <!-- 背景-->
    <div class="bj">
        <img src="/ArcticTern_1/public/static/img/about/BJ000.jpg" height="500px" width="100%">
    </div>
    <!-- 背景结束-->
    ...
    <div class="content_2">
        ...
        <div class="text_img">
            <img src="__IMG_/about/BJ001.png">
        </div>
