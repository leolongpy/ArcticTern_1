<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\xampp\htdocs\ArcticTern_1/application/admin\view\index\adminedit.html";i:1532931200;}*/ ?>
<!DOCTYPE html>
<html>
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" method="post" action="<?php echo url('admin/update/update'); ?>">
          <div class="layui-form-item">
                <label for="username" class="layui-form-label">
                    <span class="x-red">*</span>ID
                </label>
                <div class="layui-input-inline">
                    <input type="text" id="username" name="id" required="" lay-verify="required"
                    autocomplete="off" value="" class="layui-input">
                </div>
                <div class="layui-form-mid layui-word-aux">
                    <span class="x-red">*</span>您的专属ID
              </div>
          </div> 
          <div class="layui-form-item">
              <label for="username" class="layui-form-label">
          ...
          <div class="layui-form-item">
              ...
              <button  id="update" name="button" class="layui-btn" lay-filter="add" lay-submit="">
                  修改
              </button>
          </div>
      </form>
