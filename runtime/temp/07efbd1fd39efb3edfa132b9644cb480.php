<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\xampp\htdocs\ArcticTern_1/application/admin\view\index\admincate.html";i:1532931201;}*/ ?>
<!DOCTYPE html>
<html>
      ...
      <table class="layui-table">
        ...
        <tbody>
          <tr>
            ...
            <td>会员相关</td>
            <td class="td-manage">
              <a title="编辑"  onclick="x_admin_show('编辑','<?php echo url('adminEdit'); ?>')" href="javascript:;">
