<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"D:\xampp\htdocs\ArcticTern_1/application/admin\view\index\cate.html";i:1531446158;}*/ ?>
<!DOCTYPE html>
<html>
      ...
      <table class="layui-table layui-form">
        ...
        <tbody class="x-cate">
          <tr cate-id='1' fid='0' >
            ...
            <td class="td-manage">
              <button class="layui-btn layui-btn layui-btn-xs"  onclick="x_admin_show('编辑','<?php echo url('adminEdit'); ?>')" ><i class="layui-icon">&#xe642;</i>编辑</button>
              <button class="layui-btn layui-btn-warm layui-btn-xs"  onclick="x_admin_show('编辑','<?php echo url('adminEdit'); ?>')" ><i class="layui-icon">&#xe642;</i>添加子栏目</button>
