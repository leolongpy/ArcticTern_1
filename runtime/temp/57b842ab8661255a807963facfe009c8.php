<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"E:\xampp\htdocs\ArcticTern_1/application/login\view\index\zhuye.html";i:1533023031;s:56:"E:\xampp\htdocs\ArcticTern_1\application\common\nav.html";i:1531969638;s:59:"E:\xampp\htdocs\ArcticTern_1\application\common\footer.html";i:1531103305;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="subNav">
        ...
        <div class="nav">
            <div class="nav-top">
                ...
                <div class="tx_all" style="width: 100%;">
                    <div class="tx">
                        <img id="imgAjax" src="/ArcticTern_1/public/static/img/uploads/<?php echo $des['picture']; ?>">
                    </div>
                    <form action="<?php echo url('index/upload'); ?>" enctype="multipart/form-data" method="post" style="text-align: center;">
                        <label for="file" class=" btn btn-default" style="background-color: ">更换头像</label>
                        <input id="file" name="image" type="file" style="display:none; line-height: 30px;">
                        <input type="submit" id="sub" name="sub" value="保存" style="background-color: #3f9f5f; border: none; height: 34px; color: white; border-radius: 5px;">
                    </form>
                </div>
