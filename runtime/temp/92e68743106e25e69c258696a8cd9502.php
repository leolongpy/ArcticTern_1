<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\xampp\htdocs\ArcticTern_1/application/admin\view\index\orderlist.html";i:1532931231;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="con">
        <div class="info">
            ...
            <button class="layui-btn layui-btn-danger"
                    onclick="x_admin_show('删除路线','<?php echo url('orderDelete',array('id'=>$des['id'])); ?>')"><i
                    class="layui-icon"></i>删除
            </button>
            <button class="layui-btn" onclick="x_admin_show('审核路线','<?php echo url('orderShenhe',array('id'=>$des['id'])); ?>')"><i
                    class="layui-icon"></i>审核通过
            </button>
            <button class="layui-btn" onclick="x_admin_show('编辑路线','<?php echo url('orderAdd',array('id'=>$des['id'])); ?>')"><i
                     class="layui-icon"></i>编辑路线
            </button>
...
<script>
    $('.sre').click(function () {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo url('admin/index/ajax'); ?>",
            dataType: "JSON",
            data: dataObj,
   ...
   <button class="layui-btn" onclick="x_admin_show('审核路线','orderShenhe?id=${data[i]['id']}')"><i class="layui-icon"></i>审核通过</button>
