<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"E:\xampp\htdocs\ArcticTern_1/application/admin\view\index\index.html";i:1533087259;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    ...
    <script src="/ArcticTern_1/public/static/admin/lib/layui/layui.js" charset="utf-8"></script>
...
<body>
    ...
    <div class="container">
        ...
        <ul class="layui-nav right" lay-filter="">
          <li class="layui-nav-item">
            <a href="javascript:;"><?php echo \think\Session::get('a_name'); ?></a>
      ...
      <div id="side-nav">
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<?php echo url('memberList'); ?>">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>用户列表</cite>
                        </a>
                    </li >
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<?php echo url('orderList'); ?>">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>审核列表</cite>
                        </a>
                    </li >
                    <li>
                        <a _href="<?php echo url('orderList2'); ?>">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>通过列表</cite>
                        </a>
                    </li >
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<?php echo url('adminList'); ?>">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>管理员列表</cite>
                        </a>
                    </li >
